...
const BLUE_TEAM_COLOR = 0x1313FF;
...
function getTeamColorMessage(teamId) {
    return teamId === 1 ? RED_TEAM_COLOR : BLUE_TEAM_COLOR;
}

function getOwnGoalTeamColorMessage(teamId) {
    return teamId === 1 ? BLUE_TEAM_COLOR : RED_TEAM_COLOR;
}
